...
public class AddMechanic implements Command<MechanicDto> {
	...
	Optional<Mechanic> me = Factory.repository.forMechanic()
		.findByDni(dto.dni);
	BusinessChecks.isTrue(me.isEmpty(),
		"There can't be two mechanics with same dni");
    ...
    /**
     * Si salen errores con consultas es pq falta por quitar los @Transient
     * modelo dominio
     */
