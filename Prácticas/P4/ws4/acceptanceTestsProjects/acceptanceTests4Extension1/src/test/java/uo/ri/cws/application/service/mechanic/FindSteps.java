...
public class FindSteps {
	...
	private List<MechanicBLDto> list = new ArrayList<>();
	...
	public void i_search_mech_in_a_non_existent_type() throws BusinessException {
		list = service.findMechanicsWithContractInForceInContractType(UUID.randomUUID().toString());
	}

	@When("I search mechanics in contract type PERMANENT")
	public void i_find_a_payroll() throws BusinessException {
		list = service.findMechanicsWithContractInForceInContractType("PERMANENT");
