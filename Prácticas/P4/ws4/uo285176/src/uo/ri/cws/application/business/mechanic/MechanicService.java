...
public interface MechanicService {
	 ...
	 *                                  empty string BusinessException if there
	 *                                  already exists another mechanic with the
	 *                                  same dni
	 */
	 ...
	 * @throws BusinessException        if the mechanic does not exist or if
	 *                                  there are work orders registered for
	 *                                  this mechanic or if there are contracts
	 *                                  for this mechanic (regarding the state)
	 ...
	 *                           IllegalArgumentException when the argument is
	 *                           null or any of the fields (id, dni, name,
	 ...
	 */
	Optional<MechanicBLDto> findMechanicById(String idMechanic)
	 ...
	 *                                  DOES NOT throw BusinessException
	 */
	Optional<MechanicBLDto> findMechanicByDni(String dniMechanic)
			throws BusinessException;
	...
	List<MechanicBLDto> findMechanicsWithContractInForceInContractType(
