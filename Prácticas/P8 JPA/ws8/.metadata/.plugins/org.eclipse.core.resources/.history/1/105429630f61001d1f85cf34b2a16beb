...
public class MechanicJpaRepository extends BaseJpaRepository<Mechanic>// implementaciones genéricas
	...
	public Optional<Mechanic> findByDni(String dni) {
		...
		TypedQuery<Mechanic> tq = em.createNamedQuery("Mechanic.findByDni", Mechanic.class).setParameter(1, dni);
