...
public class WorkOrder extends BaseEntity {
    ...
    public WorkOrder(Vehicle v, LocalDateTime now, String desc) {
	ArgumentChecks.isNotNull(v, "The vehicle can't be null");
	ArgumentChecks.isNotNull(now, "The date can't be null");
	ArgumentChecks.isNotNull(desc, "The description can't be null");
	ArgumentChecks.isNotEmpty(desc, "The date can't be empty");
	...
	if (!this.status.equals(WorkOrderState.FINISHED)
		|| this.invoice == null)
	    throw new IllegalStateException();
	this.status = WorkOrderState.INVOICED;
    }
	...
	if (!this.status.equals(WorkOrderState.OPEN) || this.mechanic != null)
	    throw new IllegalStateException();
     ...
     * moved back to OPEN state and unlink
     * 
     * @see UML_State diagrams on the problem statement document
	...
	return this.status.equals(WorkOrderState.INVOICED);
    }
